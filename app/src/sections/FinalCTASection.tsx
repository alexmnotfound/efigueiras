      ...
      <div className="relative z-10 max-w-[640px] mx-auto px-6 md:px-12 text-center">
        <ScrollReveal>
          <h2 className="text-3xl md:text-[48px] font-semibold leading-[1.12] tracking-[-0.015em] text-white mb-5">
            &iquest;Listo para transformar tu manera de ser&quest;
          </h2>
        </ScrollReveal>

        <ScrollReveal delay={0.15}>
          <p className="text-lg leading-[1.7] text-white/80 mb-10">
            Agenda una sesion de descubrimiento gratuita. Sin compromiso, sin
        ...
        <ScrollReveal delay={0.3}>
          <a
            href="mailto:hola@coachontologico.es"
            className="inline-flex items-center gap-2 bg-coach-accent text-white text-base font-semibold px-10 py-4 rounded-full transition-all duration-200 hover:bg-coach-accent-hover hover:scale-[1.04] hover:shadow-[0_12px_32px_rgba(196,114,74,0.35)]"
          >
            Agendar sesion gratuita
            <ArrowRight size={18} />
          </a>
        </ScrollReveal>
        ...
        <ScrollReveal delay={0.45}>
          <p className="text-sm text-white/50 mt-5">
            Primera sesion gratuita &middot; 100% confidencial &middot; Sin
            compromiso
          </p>
        </ScrollReveal>
      </div>
