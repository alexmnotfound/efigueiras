...
const pillars = [
  {
    ...
    title: 'Lenguaje',
    description:
      'Las palabras crean mundos. Tu dialogo interno, las historias que te cuentas y las conversaciones que mantienes definen lo que es posible para ti.',
  },
  {
    icon: Heart,
    title: 'Emociones',
    description:
      'Tus estados de animo no son reacciones automaticas. Son territorios que puedes aprender a habitar con intencion. La inteligencia emocional es la base del liderazgo autentico.',
  },
  {
    icon: Activity,
    title: 'Corporalidad',
    description:
      'Tu cuerpo almacena patrones de tension, posturas y gestos que refuerzan o limitan tu accion. Transformar tu presencia fisica es transformar tu impacto.',
  },
];
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-[5%]">
          ...
          <ScrollReveal direction="left" className="lg:w-[45%]">
            ...
            <p className="text-lg leading-[1.7] text-coach-text-muted mb-8">
              El coaching ontologico trabaja sobre tres dominios fundamentales
            ...
            <p className="text-base font-medium text-coach-primary">
              ...
              <span className="text-coach-accent">ser diferente</span> para
              hacer diferente.
            </p>
          </ScrollReveal>
            ...
            {pillars.map((pillar) => (
              <ScrollRevealItem key={pillar.title}>
                <motion.div
                  ...
                  className="bg-white border-t-[3px] border-coach-accent rounded-[10px] p-8 shadow-card"
                >
                  <pillar.icon
                    size={28}
                    className="text-coach-accent mb-4"
                    strokeWidth={1.5}
                  />
